import { MorePostIon, NoTagPost, ReelIconFill } from "../assets/icon";
import { posts } from "../Data/postsData";

export const ProfilePostTag = () => {
  if (posts.length === 0) {
    return (
    ...
    <div className="grid grid-cols-3 gap-px">
      {[...posts].reverse().map((post) => (
        ...
        >
          ...
          {/* Corner icon */}
          <div className="absolute top-2 right-2 text-white drop-shadow-md w-5 h-5">
            {post.videoUrl ? (
