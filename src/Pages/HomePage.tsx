...
const HomePage = () => {
  ...
  const items = [myStory, ...defaultStories]; // prepend your story
    ...
    <div className="w-full h-full  md:px-[132px]">
      ...
      <div className="pt-10 md:pt-5 w-full justify-center  flex flex-row">
        <div className="w-full md:w-[630px] ">
          <div className="w-full md:w-[630px] px-2 sm:px-4 md:px-0 pt-5 md:mt-0 relative">
            <style>{`
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    >
                      <div className="bg-white rounded-full p-[3px] relative">
                        ...
                        />
                        {s.isUser && (
                          <span className="absolute bottom-0 right-0 bg-black text-white text-xs rounded-full px-[4px] pb-[1px]">
                            +
                          </span>
                        )}
                      </div>
          ...
          <div className="w-full justify-self-center-safe ml-none md:ml-11  mt-3 md:mt-8 md:w-[468px]  flex flex-col">
        ...
        <div className="w-[383px] pl-[60px] hidden md:block  pt-4">
