...
export const SendIcon = ({ color = "currentColor" }: SendIconProps) => {
  return (
    <svg
      aria-label="Share"
...
export const HiddenIcon1 = () => {
  return (
    <svg
      aria-label="Eye-off icon for the hidden requests"
      className="x1lliihq x1n2onr6 x5n08af"
      fill="currentColor"
      height="24"
      role="img"
...
export const NotificationsIconFill = () => {
  return (
    <svg
      aria-label="Notifications"
      className="x1lliihq x1n2onr6 x5n08af"
